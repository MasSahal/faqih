...
if (isset($_POST['submit'])) {
    ...
    $id_matkul      = htmlentities(strip_tags(trim($_POST['id_matkul'])));
    ...
    if ($pesan_error === "") {
        ...
        //buat query insert
        $query = "UPDATE mata_kuliah SET matkul='$matkul', hari='$hari', jam_masuk='$jam_masuk', jam_keluar='$jam_keluar' WHERE id_matkul='$id_matkul'";
        ...
        if ($result) {
            $pesan = "Data matkul $matkul telah berhasil diperbarui!";

            //redirect ke halaman tampil matkul
            header("location:tampil_mata_kuliah.php?pesan=$pesan");
        } else {
            die("Data matkul $matkul tidak berhasil diperbarui : err - " . mysqli_errno($link) . " - " . mysqli_error($link));
        }
    }
} else {
...
<head>
    ...
    <title>Kampusku - Edit Mata Kuliah</title>
</head>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h4 class="text-center mt-3 mb-4">Form Edit Mata Kuliah</h4>
                        <form action="./edit_mata_kuliah.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="hidden" name="id_matkul" id="id_matkul" value="<?= $id_matkul; ?>">
                                    </div>
                                    <div class="form-group mb-3">
